...
- [Ротация кейсов по сегментам](feedback_ротация_кейсов_по_сегментам.md) — банк шире используемого → не гонять одну тройку через все сегменты; surface неиспользованные, варьировать или обосновать повтор. Lexis 2026-06-24
...
- 🔴 [Сегмент не клон прошлой цепочки](feedback_сегмент_не_клон_прошлой_цепочки.md) — усилено Lexis 2026-06-24: читать ВСЕ письма соседней цепочки до карты болей; де-clon сверять ПОЗИЦИОННО №N↔№N по ядру боли/механике/цифрам, не по заходам (вшито в копирайтер+ревьюер B2)
