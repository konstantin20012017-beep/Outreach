...
- [10 тем на выбор для каждой цепочки](feedback_10_тем_на_выбор.md) — тема слабое место → всегда 10 вариантов, любой проект (зашито в skill+агент). 2026-06-24. Усилено С3: блок 10 тем В HTML-файле (не только чат) + ≥половина тем с конкретной атрибутированной цифрой (generic = слабо)
