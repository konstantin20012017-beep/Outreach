...
- 🔴 [Гомоглифы: RU-путь не печатать руками](feedback_гомоглифы_в_путях.md) — Bash через find→переменную; Read/Edit — литерал из свежего вывода. 9-й слип МояКоманда 2026-06-24 (даже `cd` ловит); техника `F=$(find ...)` → всё через `"$F"`
- [Сегмент: идентифицировать по канону клиента, не по своей нумерации](feedback_идентификация_сегмента.md) — «сегмент N» сверять по должности/боли, не по порядку файлов; нет файла → уточнить. МояКоманда 2026-06-24 (принял С1 за IT)
...
- [NUMIS](project_numis.md) — SaaS аналитика управления продажами (numi.plus). Бриф 2026-06-24, цепочки не начаты. ЦА B2B РФ, отдел продаж от 3 чел. CTA-якорь — бесплатный разбор продаж за 30 мин (собственник Е. Дубровин). Блокеры: реальные кейсы с цифрами, регалии, выбор оси сегментации (роль ЛПР vs размер отдела)
