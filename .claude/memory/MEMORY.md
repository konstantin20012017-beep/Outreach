...
- [Письмо №1 — pain-first, без самопрезентации](feedback_letter1_pain_first.md) — №1 открывать болью/триггером ПОЛУЧАТЕЛЯ; опенер «Меня зовут …, команда …» в первой строке запрещён, продукт после боли, бренд мельком позже (формула 4.2 PC/PEC/PPC). dialeads С1/С2/С3 2026-06-28. Проверять в ревью (ось C)
- [Боль про издержки → выгода собственника](feedback_pain_to_business_consequence.md) — боли «переизбыток кадров/ФОТ» разворачивать в деньги собственника (сократили ФОТ → высвобожденный бюджет в рост), не в операционное «не хватает рук». dialeads 2026-06-28 (доп. к дуге боли)
...
- [dialeads](project_dialeads.md) — техпартнёр (AI/интеграции/MVP). **2026-06-28: все 3 сегмента переведены в v2 (pain-first) в `цепочки/`** — С1 v2 (фокус ФОТ-экономия собственника), С2 v2 (+ мотив оперативности 1С/CRM/сайт), С3 v2 (№1 pain-first; №2/№3/темы — ещё старый стиль). Темы нейтральные «Вопрос для {Компания}». Блокер прежний — реальные кейсы с цифрами (клиент: «кейсов нет, пока пропускаем»)
...
- HTML открывать в Google Chrome; готовые файлы открывать сразу после ПЕРВОГО создания. Но при итеративных правках одного файла НЕ авто-открывать каждую версию — открывать по запросу/на финале ([feedback_chrome_open_target_last](feedback_chrome_open_target_last.md), dialeads 2026-06-28)
